 ...
 * [Unit-тесты](https://ru.wikipedia.org/wiki/Модульное_тестирование). Методика используемая при тестировании приложений или отдельных его частей.
 * [Fluent Assertions](https://fluentassertions.com/introduction). Библиотека позволяющая писать более читабельные тесты при Unit-тестировании.
